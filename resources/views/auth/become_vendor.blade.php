                                        ...
                                        <form method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
                                                    ...
                                                    <option value="2022">2022-01-10</option>
                                                    <option value="2023">2023-01-10</option>
                                                    <option value="2024">2024-01-10</option>
                                                    <option value="2025">2025-01-10</option>
                                                    <option value="2026">2026-01-10</option>
                                                </select>
                                            </div>
